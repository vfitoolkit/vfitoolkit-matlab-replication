function C=DiazGimenezPrescottAlvarezFitzgerald1992_ConsumptionFn(N_val,Aprime_val,Kprime_val, A_val,K_val, s_val,z_val,phi,e,omega,w1,w2,w3,w4,theta,i_d,i_l,mew,alpha,alpha_k,gamma,tau,psi,delta_r,Experiment)
...
if s_val==4 % If HH is dead, just overrule everything and give zero consumption
    C=0;
end
