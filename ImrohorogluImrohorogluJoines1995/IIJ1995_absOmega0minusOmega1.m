...
% Params.Tr_beq=0;
Params.LumpSum=GEandLumpSum(2);

GEprices=GEandLumpSum(1);
...
if heteroagentoptions.verbose==1
    fprintf('GEprices: r=%8.4f \n', Params.r)
    fprintf('GeneralEqmConditions: %8.4f \n', GeneralEqmConditionsVec)
    fprintf('Omega0 and Omega1: Omega0=%8.4f Omega1=%8.4f \n', Omega0, Omega1)
end

EqmCondns=sum([1,1].*(EqmCondns)); % Use the same weights
