...
TableColumn.CollegeDropoutRate=MomentsForTables(10);
...
TableColumn.FigureData.CollegeCompletion=100*[mean(CollegeCompletion(logical(Indicator_EarningsQuintile1)));...
...
TableColumn.FigureData.CollegeDropout=100*[mean(CollegeDropout(logical(Indicator_EarningsQuintile1)));...
    mean(CollegeDropout(logical(Indicator_EarningsQuintile2)));...
    mean(CollegeDropout(logical(Indicator_EarningsQuintile3)));...
    mean(CollegeDropout(logical(Indicator_EarningsQuintile4)));...
    mean(CollegeDropout(logical(Indicator_EarningsQuintile5)))];
