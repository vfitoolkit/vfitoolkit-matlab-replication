function pb=LuanWallenius2015_PB(swa,dia,pba,agej,agejshifter,w_low_i,w_peak_premium_i,lbar,ppmax,N_j,agej_65,regime)
...
if regime==0
    ...
    ap=LuanWallenius2015_AP(swa,dia,agej,agejshifter,w_low_i,w_peak_premium_i,lbar,ppmax,N_j);
    ...
    capital=LuanWallenius2015_capital(accrual_end,agejshifter,w_low_i,w_peak_premium_i,lbar);
