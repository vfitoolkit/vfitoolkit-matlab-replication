...
Reading A is what we adopt in \verb|LaunWallenius2015.m|. It is the simplest aggregation rule consistent with LW2015's own reported numbers, matches the LW2016 sequel code's stylistic preference for independent-event products in [Compusswe/Version 1/lch1.m], and uses every Table~4 parameter at face value without renormalization. Reading B is decisively ruled out by the paper's own age-70 distribution.
