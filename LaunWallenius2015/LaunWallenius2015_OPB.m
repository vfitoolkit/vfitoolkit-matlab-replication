function opb=LaunWallenius2015_OPB(swa,dia,agej,agejshifter,w_c0_i,w_c1_i,w_c2_i,lbar,ppmax,N_j,collar,agej_65,regime)
...
% DI claimants get OPB_DI top-up instead (handled in LaunWallenius2015_OPB_DI.m),
...
if regime<2
    ...
    if collar==0
        ...
        for real_ages_5559=55:59
            w_5559=w_c2_i*real_ages_5559.^2+w_c1_i*real_ages_5559+w_c0_i;
        ...
        if j_retire>=1
            real_age_retire=j_retire+agejshifter;
            w_retire=(w_c2_i*real_age_retire^2+w_c1_i*real_age_retire+w_c0_i)*lbar;
        else
            w_retire=0;
        end
