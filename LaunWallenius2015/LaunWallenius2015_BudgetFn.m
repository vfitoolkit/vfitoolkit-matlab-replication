function net_surplus=LaunWallenius2015_BudgetFn(d,kprime,k,hist_idx,h,agej,r,tax_thresh,tau_l1,tau_l2,tau_ss,tau_c,T,w_c0_i,w_c1_i,w_c2_i,collar_i,lbar,ppmax,N_j,agejshifter,agej_65,regime)
...
% loop iterates on.
%
% Mirrors the consumption / tax / benefit logic from LaunWallenius2015_ReturnFn,
...
if d==1 || d==5
    real_age=agej+agejshifter;
    w_age=w_c2_i*real_age^2+w_c1_i*real_age+w_c0_i;
    earnings=w_age*lbar;
else
    earnings=0;
end
...
% --- Benefits ---
PB    =LaunWallenius2015_PB    (swa,dia,pba,agej,agejshifter,w_c0_i,w_c1_i,w_c2_i,lbar,ppmax,N_j,agej_65,regime);
DI    =LaunWallenius2015_DI    (swa,dia,    agej,agejshifter,w_c0_i,w_c1_i,w_c2_i,lbar,ppmax,N_j,agej_65,regime);
OPB   =LaunWallenius2015_OPB   (swa,dia,    agej,agejshifter,w_c0_i,w_c1_i,w_c2_i,lbar,ppmax,N_j,collar_i,agej_65,regime);
OPB_DI=LaunWallenius2015_OPB_DI(    dia,        agejshifter,w_c0_i,w_c1_i,w_c2_i,lbar,                collar_i);
